namespace Fusion.KCC
{
	...
	/// <summary>
	/// Default processor implementation without support of [Networked] properties.
	...
	public abstract class KCCProcessor : MonoBehaviour, IKCCProcessor, IKCCProcessorProvider
	{

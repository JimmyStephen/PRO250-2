...
// Copy of default NetworkDebugStart class shipped with Fusion. Normally overriding InitializeNetworkRunner would be enough,
// but we are also using custom GUI class NetworkDebugStartGUI
// Changes: Assigning of NetworkObjectPool when starting the game
namespace Projectiles
{
  ...
  public class NetworkDebugStart : Behaviour {
